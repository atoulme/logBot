...
public class LogBotMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String port = p.getProperty("port", "6667");
        String channelkey = p.getProperty("channelkey", null);
        ...
        bot.connect(server, Integer.parseInt(port), password);
        bot.joinChannel(channel, channelkey);
    }
